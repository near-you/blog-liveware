<div class="rightpart">
    <div class="rightpart_in">
        ...
        <div id="portfolio" class="tokyo_tm_section animated">
            <div class="container">
                                ...
                                <div class="inner">
                                    <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Teresa Butler"
                                        ...
                                        <a class="popup-vimeo" href="https://vimeo.com/337293658">
                                            <img src="{{asset('image/thumbs/1-1.jpg')}}" alt=""/>
                                            <div class="abs_image"
                                                 data-img-url="{{asset('image/portfolio/5.jpg')}}"></div>
                                        </a>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="inner">
                                    <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Ashley Flores"
                                        ...
                                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=7e90gBu4pas">
                                            <img src="{{asset('image/thumbs/1-1.jpg')}}" alt=""/>
                                            <div class="abs_image"
                                                 data-img-url="{{asset('image/portfolio/6.jpg')}}"></div>
                                        </a>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Derek Smith"
                                        ...
                                        <a class="soundcloude_link mfp-iframe audio"
                                           href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/471954807&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true">
                                            <img src="{{asset('image/thumbs/1-1.jpg')}}" alt=""/>
                                            <div class="abs_image"
                                                 data-img-url="{{asset('image/portfolio/4.jpg')}}"></div>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            <li class="image">
                                <div class="inner">
                                    <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Gloria Jenkins"
                                         data-category="Image">
                                        <a class="zoom" href="{{asset('image/portfolio/3.jpg')}}">
                                            <img src="{{asset('image/thumbs/1-1.jpg')}}" alt=""/>
                                            <div class="abs_image"
                                                 data-img-url="{{asset('image/portfolio/3.jpg')}}"></div>
                                        </a>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="inner">
                                    <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Selena Gomez"
                                        ...
                                        <a class="popup_info" href="#">
                                            <img src="{{asset('image/thumbs/1-1.jpg')}}" alt=""/>
                                            <div class="abs_image"
                                                 data-img-url="{{asset('image/portfolio/7.jpg')}}"></div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="details_all_wrap">
                                    <div class="popup_details">
                                        <div class="main_details">
                                            <div class="textbox">
                                                <p>We live in a world where we need to move quickly and iterate on our
                                                    ...
                                                    of modification.</p>
                                                <p>Mockups are useful both for the creative phase of the project - for
                                                    ...
                                                    and development process allows you to quickly and easily ideate.</p>
                                            </div>
                                            <div class="detailbox">
                                                <ul>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="share">
                                                            <li><a href="#"><i class="icon-facebook-squared"></i></a>
                                                            </li>
                                                            <li><a href="#"><i class="icon-twitter-squared"></i></a>
                                                            </li>
                                                            <li><a href="#"><i class="icon-behance-squared"></i></a>
                                                            </li>
                                                            <li><a href="#"><i class="icon-linkedin-squared"></i></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="list_inner">
                                                        <div class="my_image">
                                                            <img src="{{asset('image/thumbs/4-2.jpg')}}" alt=""/>
                                                            <div class="main"
                                                                 data-img-url="{{asset('image/portfolio/1.jpg')}}"></div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="list_inner">
                                                        <div class="my_image">
                                                            <img src="{{asset('image/thumbs/4-2.jpg')}}" alt=""/>
                                                            <div class="main"
                                                                 data-img-url="{{asset('image/portfolio/2.jpg')}}"></div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                ...
                                <div class="inner">
                                    <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Ave Simone"
                                        ...
                                        <a class="popup_info" href="#">
                                            <img src="{{asset('image/thumbs/1-1.jpg')}}" alt=""/>
                                            <div class="abs_image"
                                                 data-img-url="{{asset('image/portfolio/8.jpg')}}"></div>
                                        </a>
                                    </div>
                                </div>
