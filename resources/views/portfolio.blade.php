...
<div id="portfolio" class="tokyo_tm_section active">
    <div class="container">
                        ...
                        <div class="inner">
                            <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Teresa Butler" data-category="Vimeo">
                                <a class="popup-vimeo" href="https://vimeo.com/337293658">
                                    ...
                                    <div class="abs_image" data-img-url="{{asset('image/portfolio/5.jpg')}}"></div>
                                </a>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="inner">
                            <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Ashley Flores" data-category="Youtube">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=7e90gBu4pas">
                                    <img src="{{asset('image/thumbs/1-1.jpg')}}" alt="" />
                                    <div class="abs_image" data-img-url="{{asset('image/portfolio/6.jpg')}}"></div>
                                </a>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="inner">
                            <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Derek Smith" data-category="Soundcloud">
                                <a class="soundcloude_link mfp-iframe audio" href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/471954807&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true">
                                    <img src="{{asset('image/thumbs/1-1.jpg')}}" alt="" />
                                    <div class="abs_image" data-img-url="{{asset('image/portfolio/4.jpg')}}"></div>
                                </a>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="inner">
                            <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Gloria Jenkins" data-category="Image">
                                <a class="zoom" href="{{asset('image/portfolio/3.jpg')}}">
                                    <img src="{{asset('image/thumbs/1-1.jpg')}}" alt="" />
                                    <div class="abs_image" data-img-url="{{asset('image/portfolio/3.jpg')}}"></div>
                                </a>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="inner">
                            <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Selena Gomez" data-category="Detail">
                                <a class="popup_info" href="#">
                                    <img src="{{asset('image/thumbs/1-1.jpg')}}" alt="" />
                                    <div class="abs_image" data-img-url="{{asset('image/portfolio/7.jpg')}}"></div>
                                </a>
                            </div>
                        </div>
                                        ...
                                        <li>
                                            <div class="list_inner">
                                                <div class="my_image">
                                                    ...
                                                    <div class="main" data-img-url="{{asset('image/portfolio/1.jpg')}}"></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="list_inner">
                                                <div class="my_image">
                                                    <img src="{{asset('image/thumbs/4-2.jpg')}}" alt="" />
                                                    <div class="main" data-img-url="{{asset('image/portfolio/2.jpg')}}"></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="list_inner">
                                                <div class="my_image">
                                                    <img src="{{asset('image/thumbs/4-2.jpg')}}" alt="" />
                                                    <div class="main" data-img-url="{{asset('image/portfolio/3.jpg')}}"></div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <li class="detail">
                        <div class="inner">
                            <div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Ave Simone" data-category="Detail">
                                <a class="popup_info" href="#">
                                    <img src="{{asset('image/thumbs/1-1.jpg')}}" alt="" />
                                    <div class="abs_image" data-img-url="{{asset('image/portfolio/8.jpg')}}"></div>
                                </a>
                            </div>
                        </div>
