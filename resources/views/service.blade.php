                        ...
                        <ul>
                            <li>
                                <div class="list_inner">
                                    ...
                                    <!-- Service Popup Start -->
                                    <img class="popup_service_image" src="{{asset('image/news/1.jpg')}}" alt=""/>
                                    <div class="service_hidden_details">
                                        <div class="service_popup_informations">
                                            <div class="descriptions">
                                                <p>Tokyo is a leading web design agency with an award-winning design
                            ...
                            <li>
                                <div class="list_inner">
                                    ...
                                    <!-- Service Popup Start -->
                                    <img class="popup_service_image" src="{{asset('image/news/2.jpg')}}" alt=""/>
                                    <div class="service_hidden_details">
                                        <div class="service_popup_informations">
                                            <div class="descriptions">
                                                <p>Tokyo is a leading web design agency with an award-winning design
                            ...
                            <li>
                                <div class="list_inner">
                                    ...
                                    <!-- Service Popup Start -->
                                    <img class="popup_service_image" src="{{asset('image/news/3.jpg')}}" alt=""/>
                                    <div class="service_hidden_details">
                                        <div class="service_popup_informations">
                                            <div class="descriptions">
                                                <p>Tokyo is a leading web design agency with an award-winning design
                            ...
                            <li>
                                <div class="list_inner">
                                    ...
                                    <!-- Service Popup Start -->
                                    <img class="popup_service_image" src="{{asset('image/news/4.jpg')}}" alt=""/>
                                    <div class="service_hidden_details">
                                        <div class="service_popup_informations">
                                            <div class="descriptions">
                                                <p>Tokyo is a leading web design agency with an award-winning design
                ...
                <div class="container">
                    ...
                    <div class="partners_inner">
                        <ul>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/1.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/2.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/3.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/4.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/5.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/6.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/7.png')}}" alt=""/>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <img src="{{asset('image/partners/dark/8.png')}}" alt=""/>
                                </div>
                            </li>
                        </ul>
                    </div>
